...
static int cyttsp4_mt_attention(struct cyttsp4_device *ttsp)
{
	...
	if (!md->is_suspended) {
		/* [OPT]BugID:481, Implement Enable/Disable touch function, 20130906, Mod Start */
		if(ttsp->core->enable_touch)
			/* core handles handshake */
			rc = cyttsp4_xy_worker(md);
		/* [OPT]BugID:481, Implement Enable/Disable touch function, 20130906, Mod End */
	}
...
static int cyttsp4_mt_resume(struct device *dev)
{
/* [Optical][Touch][BugID:156] Touch does not work after system resume, 20130809, Add Start */
	struct cyttsp4_mt_data *md = dev_get_drvdata(dev);
...
//	pm_runtime_get(dev);
/* [Optical][Touch][BugID:156] Touch does not work after system resume, 20130809, Add End */
	return 0;
}
#endif
